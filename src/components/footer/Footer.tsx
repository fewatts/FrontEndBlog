        ...
        <>
            <Grid container direction="row" justifyContent="center" alignItems="center">
                <Grid alignItems="center" item xs={12}>
                    <Box style={{ backgroundColor: "var(--background)", height: "120px" }}>
                        <Box paddingTop={1} display="flex" alignItems="center" justifyContent="center">
                            <Typography variant="h5" align="center" gutterBottom style={{ color: "white" }}>Conecte-se comigo nas redes sociais! </Typography>
                        </Box>
                    ...
                    <Box style={{ backgroundColor: "var(--blue)", height: "60px" }}>
                        <Box paddingTop={1}>
